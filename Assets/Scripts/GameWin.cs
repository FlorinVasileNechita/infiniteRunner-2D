...
public class GameWin : MonoBehaviour {
	...
	void OnGUI()
	{
		...
		GUI.Label(new Rect(0,0,Screen.width,Screen.height), "You Won! Your score is: " + PlayerScore.score);
		// GUI Button (width, height, x ,y)
		if (GUI.Button(new Rect(Screen.width / 2 - 150 - 18, Screen.height /2, 200, 25),"Next Level"))
		{
